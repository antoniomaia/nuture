    ...
    <section className={secondary_page_styles.simple_page_container}>
      ...
      <div className={secondary_page_styles.body}>
        <p>
          ...
          use of Ecological's Website, located at ecological.earth.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Ecological Earth if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Ecological Earth, you agreed
        ...
        <p>
          ...
          intellectual property rights for all material on Ecological Earth. All
          intellectual property rights are reserved. You may access this from
          Ecological Earth for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Ecological Earth</li>
          <li>Sell, rent or sub-license material from Ecological Earth</li>
          <li>Reproduce, duplicate or copy material from Ecological Earth</li>
          <li>Redistribute content from Ecological Earth</li>
        </ul>
        ...
        <p>
          ...
          Ecological does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Ecological,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Ecological shall
        ...
        <p>
          Ecological reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Ecological a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Ecological; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Ecological. Please include your name, your
        ...
        <p>
          No use of Ecological's logo or other artwork will be allowed for
